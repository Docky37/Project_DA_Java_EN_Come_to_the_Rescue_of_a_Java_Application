 ...
 * <p>
 * The WriteCountResultInFile Class, with the implementation of the interface
...
public class WriteCountResultInFile implements IWriteATreeMapInATextFile {
	 ...
	 * <p>
	 * The WriteCountResultInFile Class constructor set its TreeMap variable
	 * countResult with the passed TreeMap parameter.
	 * </p>
	 * 
	 ...
	 * </p>
	 * <p>
	 * Then we can iterate the set to get each key and value, an write them in the
	 * file.
	 * </p>
	 * 
	...
	public boolean writeInFile() {
		...
		try {
			...
			while (it.hasNext()) {
				...
				/*
				 * Write the Map key (symptom) and the Map value (number of occurrences) in the
				 * file, and perform a line feed.
				 */
